...
export default function MinimalCodePage() {
  const filePath = path.join(process.cwd(), 'app', 'templates', 'landing-pages', 'minimal', 'page.tsx');
  let code = '';
  try {
    ...
    <main className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Minimal Template Code</h1>
            <p className="text-gray-600">Read-only view of the template source.</p>
          </div>
          <a
            href="https://github.com/nazimboudeffa/coolui-nextjs/tree/main/app/templates/landing-pages/minimal"
            target="_blank"
